...
PotionList = ("Potion of Souls","Draught of Vigor","Elixir of the Bear","Flask of Souls","Elixir of the End") #Heal potion name, Armour potion name, Strength potion name, Ghost potion name & Win conditon name
WeaponList = ( # class/basic/upgraded/artefact/ice/poison/ghost/end game
    ...
    ("Axes" , "Prideful War Axe", "Purifier", "Knight's Fall", "Eclipse", "Sharpened Bone Maul" , ", Greataxe of the Fallen", "Glory of the End", "Eternal Rest")
    ...
    ("BrossBows", "Driftwood Hunting Bow" , "", "Clutch, Last Hope of Ended Dreams", "", "Venomstrike" , "Irk, Legacy of Lost Voices", "Shadow Ebon Shooter", "Hope's End, Reflex Bow of Time-Lost Memories")
    )
